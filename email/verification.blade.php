            ...
            <div class="content">
                ...
                <div class="login">
                    <div class="box-login">
                        ...
                        <div class="data-login">{{$email['to']}}</div>
                        <div class="clearer"></div>
                    </div>
                    <div class="box-login">
                        <div class="title-login">Password 
                            <div class="icon">:</div>
                        </div>
                ...
                Please click on the following link to verify your email address. By clicking on the following link you are agree to <b><a href="#">term of service</a></b>
                <div class="link">
                    <a href="{{$email['red_url']}}{{$email['verify_url']}}">
