...
<title>Everyvents | Forgot Password</title>
<style type="text/css">
    ...
    .content .login{
        width: 100%; min-height: 10px; margin-top: 30px; margin-bottom: 30px; line-height: 18px;
    }
    .content .login .box-login{
        width: 100%; min-height: 10px;
    }
    .content .login .box-login .title-login{
        width:100px; float: left; margin-right: 8px;
    }
    .content .login .box-login .title-login .icon{
        float: right;
    }
    .content .login .box-login .data-login{
        float: left;
    }
    .content .regards{
        margin-top: 30px; margin-bottom: 20px; width: auto; min-height: 10px;
    }
    .content .regards .title-regards{
        margin-bottom: 8px;
    }
...
<body>
    <div class="container">
        <div class="box">
            ...
            <div class="info">
                <div class="left">
                    Hallo. {{$email['recipient_first_name']}}
                </div>
                <div class="right">
                    {{$email['date']}}
                </div>
            ...
            <div class="content">
                ...
                <div class="login">
                    <div class="box-login">
                        <div class="title-login">Username 
                            <div class="icon">:</div>
                        </div>
                        <div class="data-login">{{$email['recipient']}}</div>
                        <div class="clearer"></div>
                    </div>
                    <div class="box-login">
                        <div class="title-login">New Password 
                            <div class="icon">:</div>
                        </div>
                        <div class="data-login">{{$email['password']}}</div>
                        <div class="clearer"></div>
                    </div>
                </div>
                If you have any questions or trouble logging in please contact our customer service.<br />
                Thank you!
                <div class="regards">
                    <div class="title-regards">Warm regards,</div>
                    <img src="http://everyvents.com/dev/everyvents/assets/img/title-everyvents.png">
                </div>
            </div>
            <div class="fitur">
                <div class="box-fitur">
